...
if ($PSBoundParameters.ContainsKey('CodexHome') -or $null -ne $env:CODEX_HOME) {
  [Console]::Error.WriteLine('CodexHome/CODEX_HOME is no longer accepted; use -UserHome or --home for an isolated user base.')
  exit 2
}
