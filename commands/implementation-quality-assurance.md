...
Also invocable as `/qa-gates` — same shim, same skill. This filename is kept for back-compat
with existing `/implementation-quality-assurance prefix=…` invocations.
