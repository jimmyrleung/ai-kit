...
6. **Write the spec** per the section contract; confirm with the user.
...
6. **Test plan** — `| # | Scenario | Inputs | Expected |`; concrete test outlines in the repo's framework over prose; at least one explicit "tests NOT needed here, because…" where a surface is deliberately skipped.
