...
- **Then synthesize:** each converted domain is handed to the generic synthesis head (Phases 0–6) — which emits the digest (Phase 5) and verifies/commits (Phase 6). A domain with a built specialized head also runs its enhancements.
